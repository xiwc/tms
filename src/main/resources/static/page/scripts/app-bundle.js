...
define('chat/chat-direct',['exports', 'aurelia-framework', 'common/common-poll', 'marked', 'clipboard', 'dropzone', 'autosize', 'jquery.scrollto', 'common/common-plugin', 'timeago'], function (exports, _aureliaFramework, _commonPoll, _marked, _clipboard, _dropzone, _autosize) {
    'use strict';
