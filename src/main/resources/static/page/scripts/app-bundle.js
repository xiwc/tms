...
define('chat/chat-direct',['exports', 'aurelia-framework', 'common/common-poll', 'marked', 'clipboard', 'autosize', 'dropzone', 'jquery.scrollto', 'timeago'], function (exports, _aureliaFramework, _commonPoll, _marked, _clipboard, _autosize, _dropzone) {
    'use strict';
    ...
    var ChatDirect = exports.ChatDirect = (_class = function () {
        ...
        ChatDirect.prototype.initChatToDropdownHandler = function initChatToDropdownHandler(last) {
            ...
            if (last) {
                _.defer(function () {
                    $(_this12.chatToDropdownRef).dropdown().dropdown('set selected', _this12.chatTo).dropdown({
...
define('resources/index',['exports', './config'], function (exports, _config) {
    ...
    function configure(aurelia) {
        ...
        aurelia.globalResources(['resources/value-converters/vc-common', 'resources/attributes/attr-task', 'resources/attributes/attr-swipebox', 'resources/attributes/attr-pastable']);
    }
});
