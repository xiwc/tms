...
define('chat/chat-direct',['exports', 'aurelia-framework', 'common/common-poll', 'marked', 'clipboard', 'dropzone', 'autosize', 'common/common-tips', 'simplemde', 'jquery.scrollto', 'common/common-plugin', 'timeago', 'hotkeys', 'textcomplete'], function (exports, _aureliaFramework, _commonPoll, _marked, _clipboard, _dropzone, _autosize, _commonTips, _simplemde) {
    'use strict';
    ...
    var ChatDirect = exports.ChatDirect = (_class = function () {
        ...
        ChatDirect.prototype.initSimpleMDE = function initSimpleMDE(textareaDom) {
        ...
        ChatDirect.prototype.initTextcomplete = function initTextcomplete() {
            ...
            $(this.chatInputRef).textcomplete([{
                ...
                replace: function replace(value) {
                    _.defer(function () {
                        _autosize2.default.update(_this15.chatInputRef);
                    }, 3000);
                    _this15.tipsActionHandler(value);
        ...
        ChatDirect.prototype.initHotkeys = function initHotkeys() {
            ...
            $(document).bind('keydown', 'ctrl+u', function (evt) {
                evt.preventDefault();
                $(_this16.btnItemUploadRef).find('.content').click();
            }).bind('keydown', 'ctrl+/', function (evt) {
                evt.preventDefault();
                _this16.emHotkeysModal.show();
            });
        ...
        ChatDirect.prototype.initChatToDropdownHandler = function initChatToDropdownHandler(last) {
            ...
            if (last) {
                _.defer(function () {
                    $(_this17.chatToDropdownRef).dropdown().dropdown('set selected', _this17.chatTo).dropdown({
