    ...
    var ChatDirect = exports.ChatDirect = (_class = function () {
        ...
        ChatDirect.prototype.initSearch = function initSearch() {
            ...
            $(this.searchRef).search({
                ...
                onResults: function onResults() {
                    $(_this10.searchRef).search('hide results');
                }
            });
        };
        ...
        ChatDirect.prototype.searchHandler = function searchHandler() {
            ...
            $.get('/admin/chat/direct/search', {
                ...
                if (data.success) {
                    _this11.toggleRightSidebar(true);
                    _this11.searchChats = data.data.content;
                    _.each(_this11.searchChats, function (item) {
                        item.contentMd = (0, _marked2.default)(item.content);
                    });
                    _this11.searchPage = data.data;
                    _this11.lastSearch = data.data.last;
                    _this11.moreSearchCnt = data.data.totalElements - (data.data.number + 1) * data.data.size;
                }
            });
        };
        ...
        ChatDirect.prototype.searchMoreHandler = function searchMoreHandler() {
            ...
            $.get('/admin/chat/direct/search', {
                ...
                if (data.success) {
                    ...
                    _this12.searchChats = _.concat(_this12.searchChats, data.data.content);
        ...
        ChatDirect.prototype.initHotkeys = function initHotkeys() {
            ...
            $(document).bind('keydown', 'ctrl+u', function (evt) {
                evt.preventDefault();
                $(_this13.emChatInputRef.btnItemUploadRef).find('.content').click();
            }).bind('keydown', 'ctrl+/', function (evt) {
                evt.preventDefault();
                _this13.emChatInputRef.emHotkeysModal.show();
            });
        };
...
//# sourceMappingURL=app-bundle-7a9343a96a.js.map